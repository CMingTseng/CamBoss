 ...
 */
public final class CaptureActivityHandler extends Handler implements DialogListener {
    ...
    public CaptureActivityHandler(qr_codeActivity activity, Vector<BarcodeFormat> decodeFormats, String characterSet) {
