package com.tutk.P2PCam264.DELUX.MultiView.Activity;
...
import com.tutk.P2PCam264.DELUX.Activity.AboutActivity;
import com.tutk.P2PCam264.DELUX.Adapter.livaviewFragmentAdapter;
import com.tutk.P2PCam264.DELUX.Basic.InitCamActivity;
import com.tutk.P2PCam264.DELUX.Device.Fragment.DeviceListFragment;
import com.tutk.P2PCam264.DELUX.EventList.Activity.EventListActivity;
import com.tutk.P2PCam264.DELUX.LiveView.Activity.LiveViewActivity;
import com.tutk.P2PCam264.DELUX.MultiView.Fragment.MultiViewFragment;
...
import com.tutk.P2PCam264.util.baidu.push.Utils;
import com.tutk.P2PCam264.util.onDropbox.LinkDropBoxActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnEvent:
                ...
                Intent intent = new Intent(MultiViewActivity.this, PlaybackActivity.NicknameListActivity.class);
            ...
            case R.id.btnGallery:
                slidingMenu.toggle(false);
                intent = new Intent(MultiViewActivity.this, PlaybackActivity.NicknameListActivity.class);
            ...
            case R.id.btnRecording:
                ...
                if (MultiViewActivity.SupportOnDropbox) {
                    intent = new Intent();
                    intent.setClass(MultiViewActivity.this, PlaybackActivity.CloudRecordingActivity.class);
            ...
            case R.id.btnPush:
                slidingMenu.toggle(false);
                intent = new Intent(MultiViewActivity.this, PlaybackActivity.PushSettingActivity.class);
