package com.tutk.P2PCam264.DELUX.LiveView.Fragment;
...
import com.tutk.P2PCam264.DELUX.Activity.AddDeviceActivity;
...
import com.tutk.P2PCam264.ui.Multi_Setting_custom_Dialog;
import com.tutk.P2PCam264.ui.Multi_Setting_custom_Dialog.On_Dialog_button_click_Listener;
...
//		intent.setClass(getActivity(), EventListActivity.class);
        intent.setClass(getActivity(), PlaybackActivity.RemoteFileActivity.class);
