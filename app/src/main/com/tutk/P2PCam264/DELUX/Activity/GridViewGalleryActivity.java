...
import com.tutk.P2PCam264.DELUX.LocalPlayback.LocalPlaybackActivity;
...
public class GridViewGalleryActivity extends SherlockActivity implements OkCancelDialogListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (enterMode == PlaybackActivity.NicknameListActivity.GALLERY_VIDEO) {
            mMode = MyMode.VIDEO;
            mode_change();
        }
...
//                    Bitmap Drawab le bd = new BitmapDrawa ble(getResources(), square);
